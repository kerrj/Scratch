...
import justin.scratch.Scripting.Dialogs.SetNumberDialog;
...
public class SetNumberVariable extends ScriptBlock implements Parcelable,SetNumberDialog.SetNumberListener {
    ...
    public void onPositiveClick(DialogFragment dialog, Bundle s) {
        if(s.containsKey("variable")){
            for(NumberVariable v: ScriptingManager.getVariables()){
